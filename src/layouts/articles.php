		...
		<div class="space-y-6">
			...
			?>
				<?php if ($post_count == 1) : ?>
					...
					<?php get_template_part('src/components/atoms/pages/post_first_card_two'); ?>

				<?php elseif ($post_count == 2) : ?>
					<!-- Post 2 - rectangle_two -->
					<?php get_template_part('src/components/atoms/pages/post_grid_card_rectangle_two'); ?>
				...
				<?php elseif ($post_count == 3) : ?>
					...
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<?php get_template_part('src/components/atoms/pages/post_grid_card_square_two'); ?>
				...
				<?php elseif ($post_count == 5) : ?>
					...
					<div>
						<?php get_template_part('src/components/atoms/pages/post_grid_card_rectangle'); ?>
